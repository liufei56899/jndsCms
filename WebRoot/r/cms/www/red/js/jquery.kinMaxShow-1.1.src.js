	...
	$.fn.kinMaxShow = function(user_options){
			...
			var default_options = {
						...
						button:{
								...
								normal:{width:'12px',height:'12px',lineHeight:'14px',right:'50%',bottom:'10px',fontSize:'10px',background:"#ebebeb",color:"#666666",textAlign:'center',marginRight:'12px',fontFamily:"Verdana",float:'left'},
								//当前 按钮样式
								focus:{background:"#fff",border:"1px solid #fff",color:"#000000"}
							},
