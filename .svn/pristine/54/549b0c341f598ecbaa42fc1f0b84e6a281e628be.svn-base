...
public abstract class BaseCmsConfig  implements Serializable {
	...
	// components
	 com.dqjy.cms.entity.main.MarkConfig m_markConfig;
	 com.dqjy.cms.entity.main.EmailConfig m_emailConfig;
	...
	public com.dqjy.cms.entity.main.MarkConfig getMarkConfig () {
		return m_markConfig;
	}
	 ...
	 */
	public void setMarkConfig (com.dqjy.cms.entity.main.MarkConfig m_markConfig) {
		this.m_markConfig = m_markConfig;
	}


	public com.dqjy.cms.entity.main.EmailConfig getEmailConfig () {
	 ...
	 */
	public void setEmailConfig (com.dqjy.cms.entity.main.EmailConfig m_emailConfig) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dqjy.cms.entity.main.CmsConfig)) return false;
		else {
			com.dqjy.cms.entity.main.CmsConfig cmsConfig = (com.dqjy.cms.entity.main.CmsConfig) obj;
