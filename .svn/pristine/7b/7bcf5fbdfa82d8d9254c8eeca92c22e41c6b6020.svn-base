...
public abstract class BaseCmsAcquisitionTemp  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dqjy.cms.entity.assist.CmsAcquisitionTemp)) return false;
		else {
			com.dqjy.cms.entity.assist.CmsAcquisitionTemp cmsAcquisitionTemp = (com.dqjy.cms.entity.assist.CmsAcquisitionTemp) obj;
