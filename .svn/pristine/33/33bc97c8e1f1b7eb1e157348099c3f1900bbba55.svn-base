...
public abstract class BaseContentCheck  implements Serializable {
	...
	private com.dqjy.cms.entity.main.CmsUser reviewer;
	...
	public com.dqjy.cms.entity.main.CmsUser getReviewer() {
		return reviewer;
	}

	public void setReviewer(com.dqjy.cms.entity.main.CmsUser reviewer) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dqjy.cms.entity.main.ContentCheck)) return false;
		else {
			com.dqjy.cms.entity.main.ContentCheck contentCheck = (com.dqjy.cms.entity.main.ContentCheck) obj;
