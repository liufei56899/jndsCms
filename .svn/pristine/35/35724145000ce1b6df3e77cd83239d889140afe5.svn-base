...
public abstract class BaseCmsVoteRecord  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dqjy.cms.entity.assist.CmsVoteRecord)) return false;
		else {
			com.dqjy.cms.entity.assist.CmsVoteRecord cmsVoteRecord = (com.dqjy.cms.entity.assist.CmsVoteRecord) obj;
