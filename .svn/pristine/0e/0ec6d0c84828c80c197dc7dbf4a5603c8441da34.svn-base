...
public abstract class BaseContentTag  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dqjy.cms.entity.main.ContentTag)) return false;
		else {
			com.dqjy.cms.entity.main.ContentTag contentTag = (com.dqjy.cms.entity.main.ContentTag) obj;
