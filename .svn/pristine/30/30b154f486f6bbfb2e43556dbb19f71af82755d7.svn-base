...
public abstract class BaseCmsAdvertisingSpace  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dqjy.cms.entity.assist.CmsAdvertisingSpace)) return false;
		else {
			com.dqjy.cms.entity.assist.CmsAdvertisingSpace cmsAdvertisingSpace = (com.dqjy.cms.entity.assist.CmsAdvertisingSpace) obj;
