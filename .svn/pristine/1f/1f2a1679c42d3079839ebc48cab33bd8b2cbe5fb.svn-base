...
public abstract class BaseCmsDictionary  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dqjy.cms.entity.assist.CmsDictionary)) return false;
		else {
			com.dqjy.cms.entity.assist.CmsDictionary cmsDictionary = (com.dqjy.cms.entity.assist.CmsDictionary) obj;
