...
public abstract class BaseContentExt  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dqjy.cms.entity.main.ContentExt)) return false;
		else {
			com.dqjy.cms.entity.main.ContentExt contentExt = (com.dqjy.cms.entity.main.ContentExt) obj;
