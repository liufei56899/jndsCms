...
public abstract class BaseCmsVoteReply  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dqjy.cms.entity.assist.CmsVoteReply)) return false;
		else {
			com.dqjy.cms.entity.assist.CmsVoteReply cmsVoteReply = (com.dqjy.cms.entity.assist.CmsVoteReply) obj;
