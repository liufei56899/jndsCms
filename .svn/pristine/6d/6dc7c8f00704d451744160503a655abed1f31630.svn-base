...
public abstract class BaseCmsVoteTopic  implements Serializable {
	...
	// collections
	private java.util.Set<com.dqjy.cms.entity.assist.CmsVoteItem> items;
	private java.util.Set<com.dqjy.cms.entity.assist.CmsVoteSubTopic> subtopics;
	 ...
	 */
	public java.util.Set<com.dqjy.cms.entity.assist.CmsVoteItem> getItems () {
		return items;
	}
	 ...
	 */
	public void setItems (java.util.Set<com.dqjy.cms.entity.assist.CmsVoteItem> items) {
		this.items = items;
	}

	public java.util.Set<com.dqjy.cms.entity.assist.CmsVoteSubTopic> getSubtopics() {
		return subtopics;
	}

	public void setSubtopics(
			java.util.Set<com.dqjy.cms.entity.assist.CmsVoteSubTopic> subtopics) {
		this.subtopics = subtopics;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.dqjy.cms.entity.assist.CmsVoteTopic)) return false;
		else {
			com.dqjy.cms.entity.assist.CmsVoteTopic cmsVoteTopic = (com.dqjy.cms.entity.assist.CmsVoteTopic) obj;
