...
public abstract class BaseCmsModel  implements Serializable {
	...
	// collections
	private java.util.Set<com.dqjy.cms.entity.main.CmsModelItem> items;
	 ...
	 */
	public java.util.Set<com.dqjy.cms.entity.main.CmsModelItem> getItems () {
		return items;
	}
	 ...
	 */
	public void setItems (java.util.Set<com.dqjy.cms.entity.main.CmsModelItem> items) {
		this.items = items;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dqjy.cms.entity.main.CmsModel)) return false;
		else {
			com.dqjy.cms.entity.main.CmsModel cmsModel = (com.dqjy.cms.entity.main.CmsModel) obj;
